...
CREATE INDEX idx_destinatario_nome_destinatario_upper ON destinatario (upper(nome_destinatario));
CREATE INDEX idx_destinatario_nome_destinatario_lower ON destinatario (lower(nome_destinatario));
